...
const name = ref('cos-sky')
const identity = ref('顾客')
const tel = ref('13261593239')
const address = ref('The Moon')
const password = ref('31415926')
const confirmPassword = ref('31415926')
...
function handleRegister() {
	...
	userRegister({
		...
		shopName: storeId.value == undefined ? "" : stores.value.filter(s => s.shopId == storeId.value)[0].name //显示商店名称
	}).then(res => {
						...
						<el-col :span="8">
							<el-form-item>
								...
								>
									...
									<el-option value="STAFF" label="门店工作人员"/>
									<el-option value="MANAGER" label="商店管理人员"/>
									<el-option value="CEO" label="经理"/>
								</el-select>
							</el-form-item>
						</el-col>
					</el-row>
						...
						<el-col :span="7" v-if="identity==='STAFF'">
							<el-form-item>
								...
								<el-select id="storeName"
								           ...
								           v-model="storeId"
								>
									<el-option v-for="s in stores" :value="s.shopId" :label="s.name"/>
								</el-select>
							</el-form-item>
						</el-col>
