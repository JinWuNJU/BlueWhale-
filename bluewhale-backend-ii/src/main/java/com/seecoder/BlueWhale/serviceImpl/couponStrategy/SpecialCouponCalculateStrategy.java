 ...
 * 500元以上区间打七折。
 */
public class SpecialCouponCalculateStrategy implements CouponStrategy {
    ...
    public double calculate(double price) {
        ...
        return Double.parseDouble(String.format("%.2f", table[index]+(price-100*index)*discount[index]));
    }
